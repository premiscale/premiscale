...
| `controller.databases.state.connection`              | Connection details for the state database. If type 'memory' is used, this is ignored.                                                                                   | `{}`                             |
...
| `controller.databases.metrics.connection`            | Connection details for the metrics database. If type 'memory' is used, this is ignored.                                                                                 | `{}`                             |
